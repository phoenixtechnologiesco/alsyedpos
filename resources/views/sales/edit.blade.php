      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body-custom">
            <form method="post" action="{{ route('sale.update', ['sale' => 1,]) }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('put')
                              ...
                              {{-- <div class="input-group pos"> --}}
                                ...
                                {{-- <select readonly required name="sale_customer_name" id="customer_name" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Select customer..." style="width: 150px">
                                  @foreach($customers as $single_customer)
                                    <option @if($sales->sale_customer_id == $single_customer->customer_id) selected @endif status_id="{{$single_customer->status_id}}" value="{{$single_customer->customer_id}}">{{$single_customer->customer_name}}</option>
                                    ?php if($sales->sale_customer_id == $single_customer->customer_id) $customerstatus = $single_customer->status_id; ?>
                                  @endforeach
                                </select> --}}
                              {{-- </div> --}}
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group">
                              ...
                              <input readonly type="number" name="sale_amount_paid" id="sale_balance_paid" class="form-control" value="{{ $sales->sale_amount_paid }}">
                        ...
                        <div class="form-last-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group">
                              ...
                              <input readonly type="number" name="sale_amount_dues" id="sale_balance_dues" class="form-control" value="{{ $sales->sale_amount_dues }}">
                            ...
                            <label for="sale_payment_method" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Payment Method")}}</label>
                              <div class="form-col-12">
                                ...
                                <select readonly required id="sale_payment_method" name="sale_payment_method" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Select Payment Method...">
                                  <option @if($sales->sale_payment_method == 'cash') selected @endif value="cash">Cash</option>
                                  <option @if($sales->sale_payment_method == 'credit') selected @endif value="credit">Credit</option>
                                </select>
                          ...
                          <div class="form-group">
                            <label for="sale_invoice_id" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Invoice ID")}}</label>
                              <div class="form-col-12">
                                <div class="myrow">
                                  {{-- <div class="col-1"></div> --}}
                                  <input readonly type="text" name="sale_invoice_id" class="form-control form-col-10" value="{{ $sales->sale_invoice_id }}">
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group ">
                              ...
                              <input readonly type="date" name="sale_invoice_date" class="form-control" value="{{ $sales->sale_invoice_date }}">
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group">
                              ...
                              <input type="file" name="sale_document" id="sale_document" class="form-control col-12" value="{{ $sales->sale_document }}">
                            </div>
                          </div>
                        </div>
                        <div class="form-col-2">
                            ...
                            <table id="myTable" class="table table-hover table-striped table-fixed order-list">
                              ...
                              <tbody class="sale-product">
                                <tr class="row table-info" >
                                  ...
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="sale_products_unit_price_i" min="0" id="sale_products_unit_price_i" class="form-control col-12"  value="{{ old('sale_products_unit_price_i', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                ...
                                @foreach($saleproducts as $singlesaleproduct)
                                  <?php
                                    ...
                                    $mygrandtotal_amount = $mysubtotal_amount + $sales->sale_free_amount + $sales->sale_add_amount;
                                    $j++; 
                                    ?>
                                @endforeach
                                ...
                                <tr class="row table-info" >
                                  <td class="col-2 firstcol" scope="col">
                                    <select name="sale_status" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Sale Status">
                                      <option @if($sales->sale_status == 'pending') selected @endif value="pending">Pending</option>
                                      <option @if($sales->sale_status == 'completed') selected @endif value="completed">Completed</option>
                                      //completed/pending
                                    </select>
                                  </td>
                                  <td class="col-2 mycol" scope="col">
                                    <select name="sale_payment_status" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Payment Status">
                                      <option @if($sales->sale_payment_status == 'paid') selected @endif value="paid">Paid</option>
                                      <option @if($sales->sale_payment_status == 'due') selected @endif value="due">Due</option>
                                      <option @if($sales->sale_payment_status == 'partial') selected @endif value="partial">Partial</option>
                                      <option @if($sales->sale_payment_status == 'overdue') selected @endif value="overdue">Overdue</option>
                                  ...
                                  <td class="col-8 lastcol" scope="col">
                                    <input type="text" name="sale_note" class="form-control col-12" value="{{ $sales->sale_note }}" >
                                  </td>
                                </tr>
                              </tfoot>
                              <tfoot class="thead-dark">
                                ...
                                <tr class="row table-info" >
                                  ...
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="sale_free_piece" class="form-control col-12" value="{{ $sales->sale_free_piece }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="sale_free_amount" id="sale_free_amount" class="form-control col-12"  value="{{ $sales->sale_free_amount }}">
                                  </td>
                                  <td class="col-2 mycol" scope="col">
                                    <input readonly type="number" name="sale_total_price" id="sale_total_price" class="form-control col-12"  value="{{ $mysubtotal_amount }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="text" name="sale_add_amount" id="sale_add_amount" class="form-control col-12"  value="{{ $sales->sale_add_amount }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
