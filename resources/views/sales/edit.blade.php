            ...
            <form id="sale_update" method="post" action="{{ route('sale.update', ['sale' => $sale->sale_id,]) }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <label for="sale_status" class="form-col-12 control-label">{{__(" Sale Status")}}</label>
                              <div class="form-col-12">
                                <select name="sale_status" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Sale Status">
                                  <option @if($sale->sale_status == "pending") selected @endif value="pending">Pending</option>
                                  <option @if($sale->sale_status == "created") selected @endif value="created">Created</option>
                                  <option @if($sale->sale_status == "completed") selected @endif value="completed">Completed</option>
                            ...
                            <label for="sale_payment_method" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Payment Method")}}</label>
                              <div class="form-col-12">
                                ...
                                <select readonly required id="sale_payment_method" name="sale_payment_method" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Select Payment Method...">
                                  ...
                                  <option @if($sale->sale_payment_method == 'nonbulk') selected @endif value="nonbulk">Non Bulk</option>
                                </select>
                                ...
                                @foreach($saleproducts as $oneselectedproduct)
                                  <tr class="row prtr">
                                    ...
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="sale_products_pieces[]" id="sale_products_pieces{{$i}}" class="form-control col-12" value="{{ $oneselectedproduct->sale_pieces_number }}">
                                    ...
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="sale_products_packets[]" id="sale_products_packets{{$i}}" class="form-control col-12" value="{{ $oneselectedproduct->sale_packets_number }}">
                                      <input readonly type="hidden" name="sale_packets_per_carton[]" id="sale_packets_per_carton{{$i}}" class="form-control col-12" value="{{ $oneselectedproduct->sale_packet_per_carton }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="sale_products_cartons[]" id="sale_products_cartons{{$i}}" class="form-control col-12" value="{{ $oneselectedproduct->sale_cartons_number }}">
                              ...
                              <thead class="thead-dark">
                                  ...
                                  <tr class="row table-info" >
                                    <td class="col-1 firstcol" scope="col">
                                      <input readonly type="number" name="sale_total_items" id="sale_total_items" class="form-control col-12" value="{{ $mytotal_items }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="sale_total_qty" id="sale_total_qty" class="form-control col-12" value="{{ $mytotal_quantity }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input type="number" name="sale_free_piece" id="sale_free_piece" class="form-control col-12" value="{{ $sale->sale_free_piece }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                    ...
                                    <td class="col-2 mycol" scope="col">
                                      <input readonly type="number" name="sale_grandtotal_price" id="sale_grandtotal_price" id="sale_grandtotal_price" class="form-control col-12"  value="{{ $mygrandtotal_amount }}">
                                    </td>
                              ...
                              <tfoot class="thead-dark">
                                ...
                                <tr class="row table-info" >
                                  ...
                                  <td class="col-8 firstcol" scope="col">
                                    <input type="text" name="sale_note" id="sale_note" class="form-control col-12" value="{{ $sale->sale_note }}" >
                                  </td>
                                  <td class="col-2 mycol" scope="col">
              ...
              <div class="card-footer row">
                <div class="col-6">
                  ...
                  <button type="submit" id="update-btn2" class="btn btn-primary btn-round pull-left">{{__('Update/Print')}}</button>
                </div>
            </form>
                <div class="col-6">
