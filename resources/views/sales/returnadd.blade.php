      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title">{{__(" Add Sale Return")}}</h5>
          </div>
          <div class="card-body-custom">
            <form method="post" action="{{ route('sale.storereturn') }}" autocomplete="off" enctype="multipart/form-data">
              @csrf
              @method('post')
                    ...
                    <div class="col-12">
                      <div class="row">
                        ...
                        <div class="form-last-col-2">
                          <div class="form-group">
                            <label for="sale_status" class="form-col-12 control-label">{{__(" Return Status")}}</label>
                              <div class="form-col-12">
                      ...
                      <div class="row">
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            <label for="sale_invoice_date" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Return Date")}}</label>
                            <div class="form-col-12 input-group ">
                              {{-- <div class="input-group-prepend">
                            ...
                            <table id="myTable" class="table table-hover table-striped table-fixed order-list">
                              ...
                              <tbody class="sale-product">
                                <tr class="row table-info" >
                                  ...
                                  <td class="col-1 mycol" scope="col">
                                    ...
                                    <input type="hidden" name="sale_pieces_per_packet_i" id="sale_pieces_per_packet_i" class="form-control col-12" min="0" value="{{ old('sale_pieces_per_packet_i', '1') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    ...
                                    <input type="hidden" name="sale_packets_per_carton_i" id="sale_packets_per_carton_i" class="form-control col-12" min="0" value="{{ old('sale_packets_per_carton_i', '1') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    ...
                                    <input type="hidden" name="sale_pieces_per_carton_i" id="sale_pieces_per_carton_i" class="form-control col-12" min="0" value="{{ old('sale_pieces_per_carton_i', '1') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                  ...
                                  <td class="col-1 mycol" scope="col">
                                    <input readonly type="text" name="sale_products_sub_total_i" id="sale_products_sub_total_i" class="form-control col-12"  value="{{ old('sale_products_sub_total_i', '0') }}">
                                  </td>
                              ...
                              <tfoot class="thead-dark">
                                <tr class="row">
                                  ...
                                  <th class="col-2 lastcol" scope="col">Recieved Change</th>
                                </tr>
                                <tr class="row table-info" >
                                  {{-- <td class="col-1 mycol" scope="col">
                                  ...
                                  <td class="col-8 firstcol" scope="col">
                                    <input type="text" name="sale_note" id="sale_note" class="form-control col-12" value="{{ old('sale_note'), '' }}" >
                                  </td>
                                  <td class="col-2 mycol" scope="col">
                              ...
                              <tfoot class="thead-dark">
                                <tr class="row">
                                  ...
                                  <th colspan="1" class="col-2 lastcol" scope="col">Returned Amount</th>
                                </tr>
                                <tr class="row table-info" >
                                  <td class="col-1 firstcol" scope="col">
                                    <input readonly type="number" name="sale_total_items" id="sale_total_items" class="form-control col-12" value="{{ old('sale_total_items', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input readonly type="number" name="sale_total_qty" id="sale_total_qty" class="form-control col-12" value="{{ old('sale_total_qty', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="sale_free_piece" id="sale_free_piece" class="form-control col-12" value="{{ old('sale_free_piece', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="sale_free_amount" id="sale_free_amount" class="form-control col-12"  value="{{ old('sale_free_amount', '0.00') }}">
                                  </td>
                                  <td class="col-2 mycol" scope="col">
                                    <input readonly type="number" name="sale_total_price" id="sale_total_price" class="form-control col-12"  value="{{ old('sale_total_price', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="sale_add_amount" id="sale_add_amount" class="form-control col-12"  value="{{ old('sale_add_amount', '0.00') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input readonly type="number" name="sale_discount" id="sale_discount" class="form-control col-12"  value="{{ old('sale_discount', '0') }}">
                                  </td>
                                  <td class="col-2 mycol" scope="col">
                                    <input readonly type="number" name="sale_grandtotal_price" id="sale_grandtotal_price" class="form-control col-12"  value="{{ old('sale_grandtotal_price', '0') }}">
                                  </td>
                                  <td class="col-2 lastcol" scope="col">
                                    <input type="number" name="sale_amount_returned" id="sale_amount_returned" class="form-control col-12"  value="{{ old('sale_amount_returned', '0') }}">
                                  </td>
                                </tr>
                              </tfoot>
                            </table>
...
<script type="text/javascript">
  ...
  $(document).on('click', '#add_button', function(e){
    ...
    sale_amount_returned = $('#sale_amount_returned').val();
    ...
    if(product_name !== "" && product_quantity !== 0 && product_unit_price !== 0 && repeated !== 1){
      ...
      if(sale_amount_returned >= grandtotal_amount){
        sale_return_change = Number(sale_amount_returned) -  Number(grandtotal_amount);
  ...
  $(document).on('change', "#sale_amount_returned", function(e){
    grandtotal_amount = $('#sale_grandtotal_price').val();
    sale_amount_returned = $('#sale_amount_returned').val();
    if(sale_amount_returned >= grandtotal_amount){
      sale_return_change = Number(sale_amount_returned) -  Number(grandtotal_amount);
  ...
  shortcut.add("enter",function(e) {
    ...
    if(activeid2 == "customercodesearch"){
      ...
      $('#'+activeid2).trigger('click');
      $('#sale_amount_returned').focus();
    }
    else if(activeid2 == "sale_amount_returned"){
      $('#'+activeid2).trigger('click');
      $('#sale_note').focus();
    }
  ...
  $(document).on('focus', '#sale_amount_returned', function(e) {
    var val = this.value; //store the value of the element
    this.value = ''; //clear the value of the element
    this.value = val; //set that value back.
  });
