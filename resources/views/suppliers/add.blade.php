                ...
                <div class="row">
                  <div class="card-body-custom col-12 ">
                    <div class="row">
                      <div class="col-3 ">
                        <div class="form-group">
                          <label for="supplier_ref_no" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Reference No.")}}</label>
                            <div class=" col-12">
                      ...
                      <div class="col-3 ">
                        <div class="form-group">
                          <label for="supplier_type" class="col-sm-2 col-10 control-label">&nbsp;&nbsp;{{__(" Supplier Type")}}</label>
                          <div class=" col-12">
                      ...
                      <div class="col-3 ">
                          <div class="form-group">
                            <label for="supplier_name" class="col-sm-2 col-10 control-label">&nbsp;&nbsp;{{__(" Supplier Name")}}</label>
                            <div class=" col-12">
                      ...
                      <div class="col-3 ">
                        <div class="form-group">
                          <label for="supplier_shop_name" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Shop Name")}}</label>
                            <div class=" col-12">
                    ...
                    <div class="row">
                      <div class=" col-6 ">
                          <div class="form-group">
                            <label for="supplier_shop_info" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Shop Description")}}</label>
                              <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_balance_paid" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Balance Paid")}}</label>
                      ...
                      <div class=" col-3 ">
                          <div class="form-group">
                            <label for="supplier_balance_dues" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Balance Dues")}}</label>
                              <div class=" col-12 input-group mb-1">
                                <div class="input-group-prepend">
                                  <span class="input-group-text rs">Rs: </span>
                                </div>
                    ...
                    <div class="row">
                      <div class=" col-6">
                        <div class="form-group">
                          <label for="supplier_email" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Email")}}</label>
                            <div class=" col-12">
                      ...
                      <div class=" col-6">
                          <div class="form-group">
                            <label for="supplier_alternate_email" class="col-sm-2 col-6 control-label">&nbsp;&nbsp;{{__(" Alternate Email")}}</label>
                            <div class=" col-12">
                    ...
                    <div class="row">
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_cnic_number" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Cnic Number")}}</label>
                            <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_phone_number" class="col-sm-2 col-8 control-label">&nbsp;&nbsp;{{__(" Phone Number")}}</label>
                            <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                          <div class="form-group">
                            <label for="supplier_office_number" class="col-sm-2 col-10 control-label">&nbsp;&nbsp;{{__(" Office Number")}}</label>
                            <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_alternate_number" class="col-sm-2 col-12 control-label">&nbsp;&nbsp;{{__(" Alternate Phone Number")}}</label>
                          <div class=" col-12">
                    ...
                    <div class="row">
                      <div class=" col-3">
                        <div class="form-group">
                          <label for="status_id" class="col-sm-2 col-12 control-label">&nbsp;&nbsp;{{__(" Status")}}</label>
                          <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_zipcode" class="col-sm-2 col-6 control-label">&nbsp;&nbsp;{{__(" Zip Code")}}</label>
                          <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_town" class="col-sm-2 col-6 control-label">&nbsp;&nbsp;{{__(" Town")}}</label>
                          <div class=" col-12">
                      ...
                      <div class=" col-3 ">
                        <div class="form-group">
                          <label for="supplier_area" class="col-sm-2 col-6 control-label">&nbsp;&nbsp;{{__(" Area")}}</label>
                          <div class=" col-12">
                    ...
                    <div class="row">
                      <div class=" col-12 ">
                        <div class="form-group">
                          <label for="supplier_shop_address" class="col-sm-2 col-6 control-label">&nbsp;&nbsp;{{__(" Shop Address")}}</label>
                          <div class=" col-12">
                    ...
                    <div class="row">
                      <div class=" col-12 ">
                        <div class="form-group">
                          <label for="supplier_resident_address" class="col-sm-2 col-6 control-label">&nbsp;&nbsp;{{__(" Residential Address")}}</label>
                          <div class=" col-12">
