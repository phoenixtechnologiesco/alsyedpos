            ...
            <table class="table-bordered">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <th colspan="2" class="mycol form-col-3" style="text-align:left;">{{number_format((float)($supplier_data->previous), 2, '.', '')}}</th>
                        {{-- number_format((float)($supplier_data->previous)-(float)$purchase_data->purchase_amount_paid,2,'.','') --}}
                        <th colspan="1" class="mycol form-col-1" style="text-align:left;"></th>
                    </tr>
                    <tr>
