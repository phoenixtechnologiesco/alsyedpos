      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body-custom">
            <form id="purchase_update" method="post" action="{{ route('purchase.update', ['purchase' => $purchase->purchase_id,]) }}" autocomplete="off"
            enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <label for="supplier_status" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Supplier Status")}}</label>
                              <div class="form-col-12">
                                <input readonly type="text" name="supplier_status" id="supplier_status" class="form-control col-12" value="@if($supplier->status_id == 1) Active @else Inactive @endif">
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group">
                              ...
                              <input readonly type="number" name="purchase_amount_paid" id="purchase_balance_paid" class="form-control" value="{{ $purchase->purchase_amount_paid }}">
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group">
                              ...
                              <input readonly type="number" name="purchase_amount_dues" id="purchase_balance_dues" class="form-control" value="{{ $purchase->purchase_amount_dues }}">
                        ...
                        <div class="form-last-col-2">
                          <div class="form-group">
                            <label for="purchase_status" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Purchase Status")}}</label>
                              <select readonly name="purchase_status" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Purchase Status">
                                <option @if($purchase->purchase_status == 'pending') selected @endif value="pending">Pending</option>
                                <option @if($purchase->purchase_status == 'ordered') selected @endif value="ordered">Ordered</option>
                                <option @if($purchase->purchase_status == 'partial') selected @endif value="partial">Partial</option>
                                <option @if($purchase->purchase_status == 'received') selected @endif value="received">Received</option>
                            ...
                            <label for="purchase_payment_method" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Payment Method")}}</label>
                              <div class="form-col-12">
                                ...
                                <select readonly required id="purchase_payment_method" name="purchase_payment_method" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Select Payment Method...">
                                  <option @if($purchase->purchase_payment_method == 'cash') selected @endif value="cash">Cash</option>
                                  <option @if($purchase->purchase_payment_method == 'credit') selected @endif value="credit">Credit</option>
                                </select>
                          ...
                          <div class="form-group">
                            <label for="purchase_invoice_id" class="form-col-12 control-label">&nbsp;&nbsp;{{__(" Invoice ID")}}</label>
                              <div class="form-col-12">
                                <div class="myrow">
                                  {{-- <div class="col-1"></div> --}}
                                  <input readonly type="text" name="purchase_invoice_id" class="form-control form-col-10" value="{{ $purchase->purchase_invoice_id }}">
                        ...
                        <div class="form-col-2">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group ">
                              ...
                              <input readonly type="date" name="purchase_invoice_date" class="form-control" value="{{ $purchase->purchase_invoice_date }}">
                        ...
                        <div class="form-last-col-4">
                          <div class="form-group">
                            ...
                            <div class="form-col-12 input-group">
                              ...
                              <input type="file" name="purchase_document" id="purchase_document" class="form-control col-12" value="{{ $purchase->purchase_document }}">
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <table id="myTable" class="table table-hover table-striped table-fixed order-list">
                              ...
                              <tbody class="purchase-product">
                                ...
                                @foreach($purchaseproducts as $oneselectedproduct)
                                  <tr class="row prtr">
                                    <td class="col-2 firstcol" scope="col">
                                      <input readonly type="text" name="purchase_products_barcode[]" id="purchase_products_barcode{{$i}}" class="form-control form-col-12" placeholder="Scan/Search barcode" value="{{ $oneselectedproduct->purchase_product_barcode }}">
                                    </td>
                                    <td class="col-3 mycol" scope="col">
                                      <input readonly type="text" name="product_name[]" id="product_name{{$i}}" class="form-control form-col-12" placeholder="Search product by name/code" value="{{ $oneselectedproduct->purchase_product_name }}">
                                      <input readonly type="hidden" name="product_code[]" id="product_code{{$i}}" class="form-control form-col-12" value="{{ $oneselectedproduct->purchase_product_ref_no }}">
                                    ...
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="purchase_products_unit_price[]" id="purchase_products_unit_price{{$i}}" class="form-control form-col-12"  value="{{ $oneselectedproduct->purchase_trade_price_piece }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="purchase_products_discount[]" id="purchase_products_discount{{$i}}" class="form-control form-col-12"  value="{{ $oneselectedproduct->purchase_trade_discount }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="purchase_products_sub_total[]" id="purchase_products_sub_total{{$i}}" class="form-control form-col-12"  value="{{ $oneselectedproduct->purchase_product_sub_total }}">
                                    </td>
                                ...
                                <tr class="row table-info" >
                                  <td class="col-2 firstcol" scope="col">
                                    <input type="text" name="purchase_products_barcode_i" id="purchase_products_barcode_i" class="form-control class="form-control form-col-12"col-12" placeholder="Barcode Search/Scan" value="{{ old('purchase_products_barcode_i', '') }}">
                                  </td>
                                  <td class="col-3 mycol" scope="col">
                                    <div class="col-12 mytblcol input-group">
                                      ...
                                      <input type="text" name="product_name_i" id="product_name_i" class="form-control form-col-12" placeholder="Product search by name/code" value="{{ old('product_name_i', '') }}">
                                      <input type="hidden" name="product_code_i" id="product_code_i" class="form-control form-col-12" value="{{ old('product_code_i', '') }}">
                                      <input type="hidden" name="product_id_i" id="product_id_i" class="form-control form-col-12" value="{{ old('product_id_i', '') }}">
                                  ...
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="purchase_products_pieces_i" min="0" id="purchase_products_pieces_i" class="form-control form-col-12" min="0" value="{{ old('purchase_products_pieces_i', '0') }}">
                                    <input type="hidden" name="purchase_pieces_per_packet_i" min="0" id="purchase_pieces_per_packet_i" class="form-control form-col-12" min="0" value="{{ old('purchase_pieces_per_packet_i', '5') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="purchase_products_packets_i" min="0" id="purchase_products_packets_i" class="form-control form-col-12" min="0" value="{{ old('purchase_products_packets_i', '0') }}">
                                    <input type="hidden" name="purchase_packets_per_carton_i" min="0" id="purchase_packets_per_carton_i" class="form-control form-col-12" min="0" value="{{ old('purchase_packets_per_carton_i', '4') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="purchase_products_cartons_i" min="0" id="purchase_products_cartons_i" class="form-control form-col-12" min="0" value="{{ old('purchase_products_cartons_i', '0') }}">
                                    <input type="hidden" name="purchase_pieces_per_carton_i" min="0" id="purchase_pieces_per_carton_i" class="form-control form-col-12" min="0" value="{{ old('purchase_pieces_per_carton_i', '20') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="purchase_products_unit_price_i" min="0" id="purchase_products_unit_price_i" class="form-control form-col-12"  value="{{ old('purchase_products_unit_price_i', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input type="number" name="purchase_products_discount_i" min="0" id="purchase_products_discount_i" class="form-control form-col-12"  value="{{ old('purchase_products_discount_i', '0') }}">
                                  </td>
                                  <td class="col-1 mycol" scope="col">
                                    <input readonly type="number" name="purchase_products_sub_total_i" min="0" id="purchase_products_sub_total_i" class="form-control form-col-12"  value="{{ old('purchase_products_sub_total_i', '0') }}">
                                  </td>
                            ...
                            <table id="myTable2" class="table table-hover table-fixed table-bordered">
                              <thead class="thead-dark">
                                  <tr class="row thead-dark-custom">
                                    ...
                                    <th colspan="1" class="col-2 lastcol" scope="col">Received Amount</th>
                                  </tr>
                                  <tr class="row table-info" >
                                    <td class="col-1 firstcol" scope="col">
                                      <input readonly type="number" name="purchase_total_items" id="purchase_total_items" class="form-control form-col-12" value="{{ $mytotal_items }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="purchase_total_qty" id="purchase_total_qty" class="form-control form-col-12" value="{{ $mytotal_quantity }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input type="number" name="purchase_free_piece" id="purchase_free_piece" class="form-control form-col-12" value="{{ $purchase->purchase_free_piece }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input type="number" name="purchase_free_amount" id="purchase_free_amount_i" class="form-control form-col-12"  value="{{ $purchase->purchase_free_amount }}">
                                    </td>
                                    <td class="col-2 mycol" scope="col">
                                      <input readonly type="number" name="purchase_total_price" id="purchase_total_price" class="form-control form-col-12"  value="{{ $mysubtotal_amount }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input type="number" name="purchase_add_amount" id="purchase_add_amount_i" class="form-control form-col-12"  value="{{ $purchase->purchase_add_amount }}">
                                    </td>
                                    <td class="col-1 mycol" scope="col">
                                      <input readonly type="number" name="purchase_discount" id="purchase_discount" class="form-control form-col-12"  value="{{ $mytotal_discount }}">
                                    </td>
                                    <td class="col-2 mycol" scope="col">
                                      <input readonly type="number" name="purchase_grandtotal_price" id="purchase_grandtotal_price" id="purchase_grandtotal_price" class="form-control form-col-12"  value="{{ $mygrandtotal_amount }}">
                                    </td>
                                    <td class="col-2 lastcol" scope="col">
                                      <input type="number" name="purchase_amount_received" id="purchase_amount_received" class="form-control form-col-12"  value="{{ old('purchase_amount_received', '0') }}">
                                    </td>
                                  </tr>
                                </div>
                              </thead>
                              ...
                              <tfoot class="thead-dark">
                                ...
                                <tr class="row table-info" >
                                  ...
                                  <td class="col-8 firstcol" scope="col">
                                    <input type="text" name="purchase_note" id="purchase_note" class="form-control col-12" value="{{ $purchase->purchase_note }}" >
                                  </td>
                                  <td class="col-2 mycol" scope="col">
                                    <select readonly name="purchase_payment_status" id="purchase_payment_status" class="selectpicker form-control col-12" data-live-search="true" data-live-search-style="begins" title="Payment Status">
                                  ...
                                  <td class="col-2 lastcol" scope="col">
                                    <input readonly type="text" name="purchase_invoice_id" class="form-control form-col-12" value="{{ $purchase->purchase_invoice_id }}">
                                    {{-- <button type="button" href="{{ route('purchase.edit', ['purchase' => 1,]) }}" class="btn btn-sm btn-warning btn-icon form-col-2" title="Re-Open">
                                      <i class="fa fa-file-text-o"></i>
                                    </button> --}}
                                  </td>
              ...
              <div class="card-footer-custom row">
                <div class="col-6">
                  <button type="submit" id="update-btn" class="btn btn-info btn-round pull-left">{{__('Update')}}</button>
                </div>
            </form>
                <div class="col-6">
...
<script type="text/javascript">
  ...
  $(document).on('click', '#add_button', function(e){
    ...
    if(product_name !== "" && product_quantity !== 0 && product_unit_price !== 0 && repeated !== 1){
      ...
      $(".purchase-product").prepend('<tr class="row prtr"><td class="col-2 firstcol" scope="col"><input readonly type="text" name="purchase_products_barcode[]" id="purchase_products_barcode'+rownum+'" class="form-control form-col-12" placeholder="Scan/Search barcode" value='+product_barcode+'></td><td class="col-3 mycol" scope="col"><input readonly type="text" name="product_name[]" id="product_name'+rownum+'" class="form-control form-col-12" placeholder="Search product by name/code" value="'+product_name+'"><input readonly type="hidden" name="product_code[]" id="product_code'+rownum+'" class="form-control form-col-12" value='+product_ref+'><input readonly type="hidden" name="product_id[]" id="product_id'+rownum+'" class="form-control form-col-12" value='+product_id+'></td><td class="col-1 mycol" scope="col"><input readonly type="number" name="purchase_products_pieces[]" id="purchase_products_pieces'+rownum+'" class="form-control form-col-12" value='+product_pieces+'><input readonly type="hidden" name="purchase_pieces_per_packet[]" id="purchase_pieces_per_packet'+rownum+'" class="form-control form-col-12" value='+pieces_per_packet+'></td><td class="col-1 mycol" scope="col"><input readonly type="number" name="purchase_products_packets[]" id="purchase_products_packets'+rownum+'" class="form-control form-col-12" value='+product_packets+'><input readonly type="hidden" name="purchase_packets_per_carton[]" id="purchase_packets_per_carton'+rownum+'" class="form-control form-col-12" value='+pieces_per_carton+'></td><td class="col-1 mycol" scope="col"><input readonly type="number" name="purchase_products_cartons[]" id="purchase_products_cartons'+rownum+'" class="form-control form-col-12" value='+product_cartons+'><input readonly type="hidden" name="purchase_pieces_per_carton[]" id="purchase_pieces_per_carton'+rownum+'" class="form-control form-col-12" value='+pieces_per_carton+'></td><td class="col-1 mycol" scope="col"><input readonly type="text" name="purchase_products_unit_price[]" id="purchase_products_unit_price'+rownum+'" class="form-control form-col-12"  value='+product_unit_price+'></td><td class="col-1 mycol" scope="col"><input readonly type="text" name="purchase_products_discount[]" id="purchase_products_discount'+rownum+'" class="form-control form-col-12"  value='+product_discount+'></td><td class="col-1 mycol" scope="col"><input readonly type="text" name="purchase_products_sub_total[]" id="purchase_products_sub_total'+rownum+'" class="form-control form-col-12"  value='+product_sub_total+'></td><td class="col-1 lastcol" align="center"><button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-sm delete-productfield" id="delete-productfield'+rownum+'" row-id="'+rownum+'" data-original-title="X" title="X"><i class="fa fa-times"></i></button></td></tr>');
      // alert(rownum);
      rownum++;
      // alert(rownum);
