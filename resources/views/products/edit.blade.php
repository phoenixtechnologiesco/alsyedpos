                    ...
                    <div class=" col-6 ">
                        <div class="form-group">
                          <label for="product_piece_per_packet" class=" col-10 control-label">&nbsp;&nbsp;{{__(" Pieces Per Packet")}}</label>
                            <div class=" col-12">
                              <input type="number" name="product_piece_per_packet" class="form-control col-12" value="{{ $product[0]->product_piece_per_packet }}">
                    ...
                    <div class=" col-6 ">
                      <div class="form-group">
                        <label for="product_piece_per_carton" class=" col-10 control-label">&nbsp;&nbsp;{{__(" Pieces Per Carton")}}</label>
                          <div class=" col-12">
                            <input type="number" name="product_piece_per_carton" class="form-control col-12" value="{{ $product[0]->product_piece_per_carton }}">
                    ...
                    <div class=" col-6 ">
                      <div class="form-group">
                        <label for="product_packet_per_carton" class=" col-10 control-label">&nbsp;&nbsp;{{__(" Packets Per Carton")}}</label>
                          <div class=" col-12">
                            <input type="number" name="product_packet_per_carton" class="form-control col-12" value="{{ $product[0]->product_packet_per_carton }}">
