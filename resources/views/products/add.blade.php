            ...
            <form method="post" action="{{ route('product.store') }}" autocomplete="off" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class=" col-md-12">
                          ...
                          @foreach($warehouses as $single_warehouse)
                            <option value="{{ $single_warehouse->warehouse_name }}">{{ $single_warehouse->warehouse_name }}</option>
                          @endforeach
                          </select>
                        </div>
                      </div>
              ...
              {{-- <div class="modal fade" id="Modalmanufactured" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                {{-- <div class="row">
                  <div class=" col-md-12 ">
                      <div class="form-group">
                        <label for="image" class=" col-md-6 control-label">&nbsp;&nbsp;{{__(" Image")}}</label>
                        <div class=" col-md-12">
