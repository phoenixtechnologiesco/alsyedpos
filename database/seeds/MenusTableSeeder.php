    ...
    */
    ...
    { 
        ...
        $this->beginDropdown('admin,superadmin', 'Settings', 'cil-settings');
            ...
            $this->insertLink('admin,superadmin', 'Edit menu',               '/menu/menu');
            $this->insertLink('admin,superadmin', 'Edit menu elements',      '/menu/element');
            $this->insertLink('admin,superadmin', 'Edit roles',              '/roles');
        ...
        $this->beginDropdown('admin,superadmin', 'Balance Sheet', 'cil-spreadsheet');
            ...
            $this->insertLink('admin,superadmin', 'Sale Wise', '/balance/badge');
            $this->insertLink('admin,superadmin', 'Purchase Wise', '/balance/modals');
            $this->insertLink('admin,superadmin', 'CreditDuration Wise', '/balance/tables');
        $this->endDropdown();
