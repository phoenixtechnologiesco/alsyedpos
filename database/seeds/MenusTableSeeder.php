    ...
    */
    ...
    { 
        ...
        $this->beginDropdown('admin,superadmin', 'Sale Report', 'cil-library');
            $this->insertLink('admin,superadmin', 'Date Wise', '/report/datereport');
            $this->insertLink('admin,superadmin', 'Cash/Credit Wise', '/report/cashcreditreport');
            $this->insertLink('admin,superadmin', 'Customer Wise', '/report/customerreport');
            $this->insertLink('admin,superadmin', 'Brand Wise',  '/report/brandreport');
            $this->insertLink('admin,superadmin', 'Company Wise', '/report/companyreport');
        $this->endDropdown();
        $this->beginDropdown('admin,superadmin', 'Balance Sheet', 'cil-spreadsheet');
            $this->insertLink('admin,superadmin', 'Customer Wise', '/balance/customers');
            $this->insertLink('admin,superadmin', 'Sale Wise', '/balance/sales');
            $this->insertLink('admin,superadmin', 'Purchase Wise', '/balance/purchases');
