...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->integer('product_packets_total')->default(0);
            $table->integer('product_cartons_total')->default(0);
            $table->integer('product_pieces_available')->default(0);
            $table->integer('product_packets_available')->default(0);
            $table->integer('product_cartons_available')->default(0);
            $table->integer('product_quantity_total');
